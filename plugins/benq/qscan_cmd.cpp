...
//			return 0;
	...
	data->pie = ntoh16(dev->rd_buf + 0x0C) + ntoh16(dev->rd_buf + 0x0E) + ntoh16(dev->rd_buf + 0x10) +
	            ntoh16(dev->rd_buf + 0x12) + ntoh16(dev->rd_buf + 0x14);
	data->pif = ntoh16(dev->rd_buf + 0x16);
	data->poe =
	    //		+ntoh16(dev->rd_buf+0x18)
	    +ntoh16(dev->rd_buf + 0x1A) + ntoh16(dev->rd_buf + 0x1C) + ntoh16(dev->rd_buf + 0x1E) +
	    ntoh16(dev->rd_buf + 0x20) + ntoh16(dev->rd_buf + 0x22);

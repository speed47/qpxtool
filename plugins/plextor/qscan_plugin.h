...
static const drivedesclist drivelist =
    ...
    {{"PLEXTOR ", DEV_PLEXTOR, "CD-R   PREMIUM ", PLEXTOR_PREMIUM, CHK_ERRC_CD | CHK_JB_CD | CHK_FETE},
     {"PLEXTOR ", DEV_PLEXTOR, "CD-R   PREMIUM2", PLEXTOR_PREMIUM2, CHK_ERRC_CD | CHK_JB_CD | CHK_FETE},

...
struct colorSet {
	QString name;
	QColor bg, grid, rspeed, wspeed, errc[8], jitter, asymm, fe, te, tapit, taland;
};

static const colorSet defColors = {
    "Default", 0xFFFFFF, 0x808080,
    0x009000,  0xC00000, {0x009000, 0x00C000, 0x00FF00, 0xFFAA00, 0x0055FF, 0x550080, 0xFF0000, Qt::black},
    0x00A000,  0xA00000, 0xA00000,
    0x0000A0,  0xA00000, 0x0000A0};
